    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                ...
                {"image_topic": LaunchConfiguration('usb_image_topic')},
                {"camera_info_topic": LaunchConfiguration('usb_camera_info_topic')},
                {"qos_depth": LaunchConfiguration('usb_qos_depth')},
            ],
