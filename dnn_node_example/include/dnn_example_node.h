...
enum class DnnParserType {
  ...
  YOLO11_SEG_PARSER,      // YOLO11-seg实例分割解析器（仅batch=1）
...
struct DnnExampleOutput : public DnnNodeOutput {
  ...
  // batch输入时按输入顺序保存每路的消息头与前处理信息
  std::vector<std_msgs::msg::Header> batch_msg_headers;
...
class DnnExampleNode : public DnnNode {
 ...
 private:
  ...
  // batch配置，当前仅对YOLO11做batch-2适配
  int batch_size_ = 1;
  int enable_batch_sync_ = 0;
  int sync_source0_index_ = 0;
  int sync_source1_index_ = 1;
  int sync_tolerance_ms_ = 25;
  ...
  std::string msg_pub_topic_name_ = "hobot_dnn_detection";
    std::string msg_pub_topic_name_0_ = "";
    std::string msg_pub_topic_name_1_ = "";
  rclcpp::Publisher<ai_msgs::msg::PerceptionTargets>::SharedPtr msg_publisher_ =
      nullptr;
    std::vector<rclcpp::Publisher<ai_msgs::msg::PerceptionTargets>::SharedPtr>
      batch_msg_publishers_;
  ...
  rclcpp::Subscription<hbm_img_msgs::msg::HbmMsg1080P>::ConstSharedPtr
    sharedmem_img_subscription_0_ = nullptr;
  rclcpp::Subscription<hbm_img_msgs::msg::HbmMsg1080P>::ConstSharedPtr
    sharedmem_img_subscription_1_ = nullptr;
  std::string sharedmem_img_topic_name_ = "/hbmem_img";
  std::string sharedmem_img_topic_name_0_ = "/hbmem_img_0";
  std::string sharedmem_img_topic_name_1_ = "/hbmem_img_1";
  void SharedMemImgProcess(
      const hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr msg);
  void SharedMemImgProcessBatch0(
    const hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr msg);
  void SharedMemImgProcessBatch1(
    const hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr msg);
  void TrySyncBatchFrames();
  int RunBatchInfer(
    const hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr msg0,
    const hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr msg1);
  std::deque<hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr> sync_queue0_;
  std::deque<hbm_img_msgs::msg::HbmMsg1080P::ConstSharedPtr> sync_queue1_;
  std::mutex sync_queue_mtx_;
#endif
